...
### 7.3 Demo Account & Seed Data

Running `python scripts/init_db.py` drops/recreates the SQLite database, seeds a few hundred realistic applicants, and provisions a ready-made demo login:

- Email: `demo_account@example.com`
- Password: `demo_pass123`

Use it to explore the dashboard immediately (you can still register your own accounts afterward).
