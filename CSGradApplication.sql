...
-- 4. Education
--    2NF: multi-valued education data is stored outside of ApplicantAccount.
CREATE TABLE EducationHistory (
    ID INT PRIMARY KEY AUTO_INCREMENT,
    ApplicantID INT NOT NULL,
    UniversityID INT NOT NULL,
    DegreeLevel ENUM('Undergraduate', 'Master', 'PhD') NOT NULL,
    Major VARCHAR(255) NOT NULL,
    GraduationYear INT NOT NULL,
    GPAScale ENUM('4.0', '100') NOT NULL DEFAULT '4.0',
...
--    Using a separate table keeps publication attributes independent per 2NF.
